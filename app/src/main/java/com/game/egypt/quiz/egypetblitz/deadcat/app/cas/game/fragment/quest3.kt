...
import com.game.egypt.quiz.egypetblitz.deadcat.app.cas.game.databinding.FragmentQuest3Binding
import com.game.egypt.quiz.egypetblitz.deadcat.app.cas.game.mainmenu


class quest3 : Fragment() {
    lateinit var binding: FragmentQuest3Binding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button8.setOnClickListener {
            ...
            t.beginTransaction()
                .replace(bindingMain.fragmentcontainer.id, q4)
                .commit()
